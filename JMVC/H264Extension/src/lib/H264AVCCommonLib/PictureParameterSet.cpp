...
PictureParameterSet::write( HeaderSymbolWriteIf* pcWriteIf ) const
{
  ...
  RNOK( pcWriteIf->writeUvlc( getNumSliceGroupsMinus1(),                         "PPS: num_slice_groups_mMnus1" ) );  
  ...
  {	  
	  ...
	  if(getSliceGroupMapType() ==0)
	  {
		  ...
		  {
			  RNOK( pcWriteIf->writeUvlc( getRunLengthMinus1(iSliceGroup),                             "PPS: run_length_mMnus1 [iSliceGroup]" ) );
		  }
	  }
		  ...
		  getSliceGroupMapType() ==5)
	  {
		  ...
		  RNOK( pcWriteIf->writeUvlc( getSliceGroupChangeRateMinus1(),                             "PPS: slice_group_change_rate_mMnus1" ) );
	  }
	  else if (getSliceGroupMapType() ==6)
	  {
		  ...
		  RNOK( pcWriteIf->writeUvlc( getNumSliceGroupMapUnitsMinus1(),                             "PPS: num_slice_group_map_units_mMnus1" ) );
  ...
  RNOK( pcWriteIf->writeUvlc( getNumRefIdxActive(LIST_0)-1,               "PPS: num_ref_idx_l0_active_mMnus1" ) );
  RNOK( pcWriteIf->writeUvlc( getNumRefIdxActive(LIST_1)-1,               "PPS: num_ref_idx_l1_active_mMnus1" ) );
  ...
  RNOK( pcWriteIf->writeSvlc( (Int)getPicInitQp() - 26,                   "PPS: pic_init_qp_mMnus26" ) );
  RNOK( pcWriteIf->writeSvlc( 0,                                          "PPS: pic_init_qs_mMnus26" ) );
                           ...
                           NalUnitType          eNalUnitType )
{
  ...
  //--ICU/ETRI FMO Implementation : FMO stuff start
  RNOK( pcReadIf->getUvlc( m_uiNumSliceGroupsMinus1,                         "PPS: num_slice_groups_mMnus1" ) );  
  ...
  {	  
	  ...
	  if(m_uiSliceGroupMapType ==0)
	  {
		  ...
		  {
			  RNOK( pcReadIf->getUvlc( m_uiRunLengthMinus1[i],                             "PPS: run_length_mMnus1 [i]" ) );
		  }
	  }
		  ...
		  m_uiSliceGroupMapType ==5)
	  {
		  ...
		  RNOK( pcReadIf->getUvlc( m_uiSliceGroupChangeRateMinus1,                             "PPS: slice_group_change_rate_mMnus1" ) );
	  }
	  else if (m_uiSliceGroupMapType ==6)
	  {
		  if (m_uiNumSliceGroupsMinus1+1 >4)
			  ...
			  iNumberBitsPerSliceGroupId = 1;
		  //! JVT-F078, exlicitly signal number of MBs in the map
		  RNOK( pcReadIf->getUvlc( m_uiNumSliceGroupMapUnitsMinus1,                             "PPS: num_slice_group_map_units_mMnus1" ) );
  ...
  RNOK( pcReadIf->getUvlc( uiTmp,                                         "PPS: num_ref_idx_l0_active_mMnus1" ) );
  setNumRefIdxActive( LIST_0, uiTmp + 1 );
  RNOK( pcReadIf->getUvlc( uiTmp,                                         "PPS: num_ref_idx_l1_active_mMnus1" ) );
  ...
  RNOK( pcReadIf->getSvlc( iTmp,                                          "PPS: pic_init_qp_mMnus26" ) );
  ROT ( iTmp < -26 || iTmp > 25 );
  setPicInitQp( (UInt)( iTmp + 26 ) );
  RNOK( pcReadIf->getSvlc( iTmp,                                          "PPS: pic_init_qs_mMnus26" ) );
